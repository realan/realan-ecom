  ...
  return <FormProvider methods={methods} onSubmit={handleSubmitForm}>
      <Grid container spacing={3}>
        ...
        xs: 12
          ...
          <TextField fullWidth color="info" size="medium" name="site_description" label="Site Description" />
        </Grid>

        <Grid size={12}>
          <TextField rows={6} fullWidth multiline color="info" size="medium" name="site_banner_text" label="Site Banner Text" />
        </Grid>
